...
network = pypsa.Network('data/network_offgrid/offgrid_2030_NH3_a.nc') 
network1 = pypsa.Network('data/network_offgrid/offgrid_2030_H2_a.nc') 
network2 = pypsa.Network('data/network_offgrid/offgrid_2030_NH3_w.nc') 
network3 = pypsa.Network('data/network_offgrid/offgrid_2030_H2_w.nc') 
...
a = pd.read_csv(r'data/sensitivity/sensitivity_nh3.csv', sep = ';', header = None) 
b = pd.read_csv(r'data/sensitivity/sensitivity_h2.csv', sep = ';', header = None) 
